...
public class LinkChecker
{
    ...
    {
        Page cascadePage = RestApi.readPage(pageId, projectInformation);
    ...
    {
        XhtmlDataDefinitionBlock block = RestApi.readXhtmlBlock(blockId, projectInformation);
     ...
     * @throws Exception
     */
    private static void checkLinks(ProjectInformation projectInformation, List<StructuredDataNode> nodes) throws Exception
    {
